...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a krypteia address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and krypteia: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your krypteia addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified krypteia addresses"));
    ...
    openAction->setStatusTip(tr("Open a krypteia: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible krypteia command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to krypteia network", "", count));
}
...
{
    QString strTitle = tr("krypteia"); // default title
