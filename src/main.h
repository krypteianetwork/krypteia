...
/** btzc: update krypteia config */
/** Default for DEFAULT_WHITELISTRELAY. */
static const bool DEFAULT_WHITELISTRELAY = true;
/** Default for DEFAULT_WHITELISTFORCERELAY. */
static const bool DEFAULT_WHITELISTFORCERELAY = true;
/** Default for -minrelaytxfee, minimum relay fee for transactions */
//btzc: update krypteia fee
static const unsigned int DEFAULT_MIN_RELAY_TX_FEE = CENT / 10; //0.001 krypteia,
...
/** The maximum size of a blk?????.dat, btzc:krypteia: 128 MiB */
static const unsigned int MAX_BLOCKFILE_SIZE = 0x8000000; // 128 MiB;
/** The pre-allocation chunk size for blk?????.dat files (since 0.8), btzc:krypteia: 16MiB */
static const unsigned int BLOCKFILE_CHUNK_SIZE = 0x1000000; // 16 MiB
/** The pre-allocation chunk size for rev?????.dat files (since 0.8), btzc:krypteia: 1MiB */
static const unsigned int UNDOFILE_CHUNK_SIZE = 0x100000; // 1 MiB
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 50000; // 50KB
/** Dust Soft Limit, allowed with additional fee per output */
//static const int64_t DUST_SOFT_LIMIT = 100000; // 0.001 KRT
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 1000;   // 0.00001 KRT mininput
...
//BTZC: ADD params for krypteia works
