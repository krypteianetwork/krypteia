...
const char * const BITCOIN_CONF_FILENAME = "krypteia.conf";
const char * const BITCOIN_PID_FILENAME = "krypteiad.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\krypteia
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\krypteia
    // Mac: ~/Library/Application Support/krypteia
    // Unix: ~/.krypteia
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "krypteia";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/krypteia";
#else
    // Unix
    return pathRet / ".krypteia";
#endif
#endif
}
